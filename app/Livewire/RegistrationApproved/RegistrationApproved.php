...
namespace App\Livewire\RegistrationApproved;
...
class RegistrationApproved extends Component
{
    use WithPagination;
    ...
    public function viewStudent($studentId)
    {
        ...
        if ($student) {
            ...
            // Get approval reason from registration_request table
            $registrationRequest = registration_request::where('students_id', $student->id)->first();
            $this->approval_reason = $registrationRequest ? $registrationRequest->remarks : 'No reason provided';
    ...
    public function render()
    {
        ...
        return view('livewire.registration-approved.registration-approved', compact('students'));
    }
}
